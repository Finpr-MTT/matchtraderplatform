    ...
    public function __construct() {
        ...
        if (get_option('matchtrader_enable_mtt_checkout', 'default') === 'multi-step') {
            ...
            add_action('matchtrader_checkout_button_place_order', function () {
                echo '<button type="submit" class="p-3 btn mtt-bg-button-next w-75 w-md-25" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr__('Place Order', 'woocommerce') . '">' . esc_html__('Place Order', 'woocommerce') . '</button>';
});
